...
<meta name="author" content="order by smallseashell.com" />
<meta name="renderer" content="webkit">
<!--ico-->
<link rel="stylesheet" type="text/css" href="${context.contextPath}/skin/css/base.css" />
<link rel="stylesheet" type="text/css" href="${context.contextPath}/skin/css/animate.min.css" />
<link rel="stylesheet" type="text/css" href="${context.contextPath}/skin/css/owl.carousel.css" />
<link rel="stylesheet" type="text/css" href="${context.contextPath}/skin/css/style.css" />
<link rel="stylesheet" type="text/css" href="${context.contextPath}/skin/css/responsive.css" />
<script src="${context.contextPath}/skin/js/jquery-1.11.0.min.js"></script>
<script src="${context.contextPath}/skin/js/wow.min_1.js"></script>
<script src="${context.contextPath}/skin/js/owl.carousel.min.js"></script>
<script src="${context.contextPath}/skin/js/page.js"></script>
</head>
<body>
...
<div class="span12">
<div class="main">
<script src="${context.contextPath}/skin/js/login.js"></script>
<div class="banner">
  <div class="rowFluid">
    <div class="span12">
      <div class="owl-demo">
        <div class="item">
          <h3 class="banner_title">打破传统-企业免网站制作费</h3>
          <div class="banner_text">2016-找我们做网站我们只收取空间域名成本价，免取网站高额制作费用。</div>
          <div class="banner_button"> <a href="http://wpa.qq.com/msgrd?v=3&uin=329435596&site=qq&menu=yes" target="_blank" title="详细咨询">马上咨询</a> </div>
        </div>
        <div class="item">
          <h3 class="banner_title">主流三合一响应式网站</h3>
          <div class="banner_text">一个网站就能自动适应PC端+平板端+手机端使用</div>
          <div class="banner_button"> <a href="/a/jzfa" class="active" title="立即体验">立即体验</a> </div>
        </div>
        <div class="item">
          ...
          <div class="index_product_content">
            <div class="span4 col-md-6 col-xs-12 wow fadeInDown"> <a  class="index_product_list" title="响应式企业网站建设">
              <div class="list_backimg list_backimg1">
                <div class="list_img"> <img src="skin/images/045.png" alt="响应式企业网站建设" /> </div>
                <div class="list_txt">
            ...
            <div class="span4 col-md-6 col-xs-12 wow flipInX"> <a  class="index_product_list" title="响应式商城网站建设">
              <div class="list_backimg list_backimg2">
                <div class="list_img"> <img src="skin/images/046.png" alt="响应式商城网站建设" /> </div>
                <div class="list_txt">
            ...
            <div class="span4 col-md-6 col-xs-12 wow fadeInRight"> <a  class="index_product_list" title="空间域名">
              <div class="list_backimg list_backimg3">
                <div class="list_img"> <img src="skin/images/047.png" alt="空间域名" /> </div>
                <div class="list_txt">
            ...
            <div class="span4 col-md-6 col-xs-12 wow fadeInDown"> <a  class="index_product_list" title="生态级行业门户">
              <div class="list_backimg list_backimg4">
                <div class="list_img"> <img src="skin/images/048.png" alt="生态级行业门户" /> </div>
                <div class="list_txt">
            ...
            <div class="span4 col-md-6 col-xs-12 wow flipInX"> <a  class="index_product_list" title="H5三合一网站">
              <div class="list_backimg list_backimg5">
                <div class="list_img"> <img src="skin/images/049.png" alt="H5三合一网站" /> </div>
                <div class="list_txt">
            ...
            <div class="span4 col-md-6 col-xs-12 wow fadeInRight"> <a  class="index_product_list" title="生态级响应式全网营销平台">
              <div class="list_backimg list_backimg6">
                <div class="list_img"> <img src="skin/images/050.png" alt="生态级响应式全网营销平台" /> </div>
                <div class="list_txt">
          ...
          <div class="platform_advantage_content">
            <div class="span4 col-xm-6 col-xs-12 wow bounceInLeft">
              <div class="platform_advantage_list">
                <div class="platform_advantage_img"> <img src="skin/images/008.png" alt="响应式建站平台" /> </div>
            ...
            <div class="span4 col-xm-6 col-xs-12 wow bounceIn">
              <div class="platform_advantage_list">
                <div class="platform_advantage_img"> <img src="skin/images/009.png" alt="响应式网站建设" /> </div>
                <div class="platform_advantage_brief">
            ...
            <div class="span4 col-xm-6 col-xs-12 wow bounceInRight">
              <div class="platform_advantage_list">
                <div class="platform_advantage_img"> <img src="skin/images/010.png" alt="响应式自助建站" /> </div>
                <div class="platform_advantage_brief">
            ...
            <div class="span4 col-xm-6 col-xs-12 wow bounceInLeft">
              <div class="platform_advantage_list">
                <div class="platform_advantage_img"> <img src="skin/images/011.png" alt="响应式网站定制" /> </div>
                <div class="platform_advantage_brief">
            ...
            <div class="span4 col-xm-6 col-xs-12 wow bounceIn">
              <div class="platform_advantage_list">
                <div class="platform_advantage_img"> <img src="skin/images/012.png" alt="html5建站平台" /> </div>
                <div class="platform_advantage_brief">
            ...
            <div class="span4 col-xm-6 col-xs-12 wow bounceInRight">
              <div class="platform_advantage_list">
                <div class="platform_advantage_img"> <img src="skin/images/013.png" alt="H5响应式网站建设" /> </div>
                <div class="platform_advantage_brief">
          ...
          <div class="response_shows">
            <div class="response_shows_box wow bounceIn">
              <div class="response_shows_width">
                <div class="pc"> <img src="skin/images/015.png" alt="建站神器" />
                  <div class="pic">
                    <div class="item"> <img src="skin/images/0511.jpg" alt="快速响应式网站制作" /> </div>
                    <div class="item"> <img src="skin/images/0512.jpg" alt="网站建设" /> </div>
                    <div class="item"> <img src="skin/images/0513.jpg" alt="响应式自助建站" /> </div>
                  </div>
                </div>
                <div class="pad"> <img src="skin/images/017.png" alt="H5响应式网站建设" />
                  <div class="pic">
                    <div class="item"> <img src="skin/images/0521.jpg" alt="建站" /> </div>
                    <div class="item"> <img src="skin/images/0522.jpg" alt="生态级响应式2.0建站平台" /> </div>
                    <div class="item"> <img src="skin/images/0523.jpg" alt="H5响应式网站建设" /> </div>
                  </div>
                </div>
                <div class="phone"> <img src="skin/images/016.png" alt="响应式网站模板" />
                  <div class="pic">
                    <div class="item"> <img src="skin/images/0531.jpg" alt="响应式网站设计案例" /> </div>
                    <div class="item"> <img src="skin/images/0532.jpg" alt="响应式网站案例" /> </div>
                    <div class="item"> <img src="skin/images/0533.jpg" alt="html5建站平台" /> </div>
                  </div>
                </div>
                <div class="thumb"></div>
              </div>
        ...
        <div class="rowFluid">
          <div class="marketing_advantage_content">
            <div class="span3 col-sm-6 wow flipInY">
              <div class="marketing_advantage_list"> <img src="skin/images/019.jpg" alt="响应式跨屏营销网站" /> </div>
            </div>
            <div class="span3 col-sm-6">
              <div class="span12 wow flipInY">
                <div class="marketing_advantage_list"> <img src="skin/images/054.jpg" />
                  <div class="marketing_advantage_brief">
                    <div class="brief_title">全网营销<span><img src="skin/images/020.png" alt="响应式网站营销" /></span></div>
              ...
              <div class="span12 wow flipInY">
                <div class="marketing_advantage_list"> <img src="skin/images/054.jpg" />
                  <div class="marketing_advantage_brief">
                    <div class="brief_title">优化搜索<span><img src="skin/images/023.png" alt="响应式网站SEO" /></span></div>
            ...
            <div class="span3 col-sm-6">
              <div class="span12 wow flipInY">
                <div class="marketing_advantage_list"> <img src="skin/images/054.jpg" />
                  <div class="marketing_advantage_brief">
                    <div class="brief_title">微信无缝对接<span><img src="skin/images/021.png" alt="平台微信营销" /></span></div>
              ...
              <div class="span12 wow flipInY">
                <div class="marketing_advantage_list"> <img src="skin/images/054.jpg" />
                  <div class="marketing_advantage_brief">
                    <div class="brief_title">二维码<span><img src="skin/images/024.png" alt="二维码分享" /></span></div>
            ...
            <div class="span3 col-sm-6">
              <div class="span12 wow flipInY">
                <div class="marketing_advantage_list"> <img src="skin/images/054.jpg" />
                  <div class="marketing_advantage_brief">
                    <div class="brief_title">社交分享<span><img src="skin/images/022.png" alt="跨屏网站社交分享" /></span></div>
              ...
              <div class="span12 wow flipInY">
                <div class="marketing_advantage_list"> <img src="skin/images/054.jpg" />
                  <div class="marketing_advantage_brief">
                    <div class="brief_title">分销体系<span><img src="skin/images/025.png" alt="响应式分销商城网站" /></span></div>
  ...
  <div class="rowFluid">
    <div class="span12">
      <div class="container">
        ...
        <div class="rowFluid">
          <div class="partners_content"> <a href="#" class="partners_content_list wow fadeInUp" data-wow-delay="0.2s" target="_blank"> <img src="skin/images/026.png" alt="阿里云" /> </a> <a href="#" class="partners_content_list wow fadeInUp" data-wow-delay="0.4s" target="_blank"> <img src="skin/images/027.png" alt="驻云" /> </a> <a href="#" class="partners_content_list wow fadeInUp" data-wow-delay="0.6s" target="_blank"> <img src="skin/images/028_1.png" alt="麦田设计" /> </a> <a href="#" class="partners_content_list wow fadeInUp" data-wow-delay="0.8s" target="_blank"> <img src="skin/images/029.png" alt="博艺通展览" /> </a> <a href="#" class="partners_content_list wow fadeInUp" data-wow-delay="1s" target="_blank"> <img src="skin/images/030.png" alt="高斌钟表" /> </a> <a href="#this" class="partners_content_list wow fadeInUp" data-wow-delay="1.2s" target="_blank"> <img src="skin/images/0311.png" alt="仙作电商" /> </a> <a href="#this" class="partners_content_list wow fadeInUp" data-wow-delay="1.4s" target="_blank"> <img src="skin/images/0322.png" alt="纳威体育" /> </a> </div>
        </div>
      </div>
    </div>
  </div>
...
<div class="join_in">
  <div class="rowFluid">
    <div class="span12">
      <div class="container">
        <div class="join_in_title wow fadeInUp">选择数立方网络，<span>让你的企业快速迈向互联网+时代</span></div>
        <div class="join_in_text wow fadeInLeft">选择对的服务商能让您更快更好的迈进互联网+时代</div>
        <a href="http://wpa.qq.com/msgrd?v=3&uin=329435596&site=qq&menu=yes " class="all_button join_in_button wow fadeInUp" target="_blank">点击咨询</a> </div>
    </div>
  </div>
</div>
          ...
          <div class="news_center_content">
            <div class="span4 col-sm-12 wow fadeInDown" data-wow-delay="1.2s">
              <div class="news_center_list">
                <div class="news_center_list_img"> <img src="skin/images/034.jpg" alt="云平台动态" /> </div>
...
<li class="span12"> <a href="/a/xinwenzixun/pingtaidongtai/1.html" class="span8" title="什么是伪静态？伪静态有何作用?哪种好？"><i class="fa fa-angle-right"></i>什么是伪静态？伪静态有何作用?哪种好？ </a>
            ...
            <div class="span4 col-sm-12 wow fadeInUp" data-wow-delay="0.7s">
              <div class="news_center_list">
                <div class="news_center_list_img"> <img src="skin/images/035.jpg" /> </div>
...
<li class="span12"> <a href="/a/xinwenzixun/bangzhuzhongxin/17.html" class="span8" title="SEO快速排名算法"><i class="fa fa-angle-right"></i>SEO快速排名算法 </a>
            ...
            <div class="span4 col-sm-12 wow fadeInDown" data-wow-delay="1.3s">
              <div class="news_center_list">
                <div class="news_center_list_img"> <img src="skin/images/036.jpg" /> </div>
...
<script src="${context.contextPath}/skin/js/effects.js"></script> 
